...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2025 at 02:22 PM
...
INSERT INTO `employee` (`emp_id`, `name`, `age`, `dept_id`, `rm_id`, `doj`) VALUES
(1, 'Alice Johnson', 29, 1, 1, '2022-01-15'),
(2, 'Bob Smith', 35, 2, 2, '2021-03-10'),
(3, 'Charlie Davis', 28, 2, 2, '2023-06-01'),
(4, 'Diana Prince', 32, 3, 3, '2020-11-20'),
(5, 'Ethan Hunt', 30, 4, 4, '2019-08-05');
